...
export function displayText(context, canvas, size, infoMatch)
{
	...
	context.fillStyle = "black";
	if (infoMatch == null) {
		context.fillText(translationsData["P1: "] + translationsData["w (up) s (down)"], size * 1.5, size * 1.5);
	}
	else {
	...
	context.fillStyle = "black";
	if (infoMatch == null) {
		context.fillText(translationsData["P2: "] + translationsData["↑ (up) ↓ (down)"], canvas.width - size * 1.5, size * 1.5);
	}
	else {
