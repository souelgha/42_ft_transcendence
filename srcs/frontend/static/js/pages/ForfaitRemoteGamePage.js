export class ForfaitRemoteGamePage {
	constructor() {
        ...
        gameContent.innerHTML = `
            <div class="match-result animate-fade-in">
                <div class="result-header">
                     <h2 class="match-title animate-slide-down" dtat-translate="matchresult">MATCH RESULT</h2>
                    <div class="players-result">
                        <div class="winner-section">
                            <span class="result-label" data-translate="forfait">VICTORY BY FORFAIT</span>
                        </div>
                    </div>
                </div>
